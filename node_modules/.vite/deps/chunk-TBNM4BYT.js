...
function update() {
  ...
  if (count3) {
    eachSafely(timeouts.splice(0, count3), (t6) => t6.handler());
    pendingCount -= count3;
  }
  if (!pendingCount) {
    stop();
...
var clamp = (min4, max4, v4) => Math.min(Math.max(v4, min4), max4);
var colors2 = {
  transparent: 0,
...
function useTransition(data, props, deps) {
  ...
  if (is.fun(sort3)) {
    transitions.sort((a4, b3) => sort3(a4.item, b3.item));
  }
  let delay = -trail;
  const forceUpdate = useForceUpdate();
...
function hslConvert(o3) {
  ...
  if (o3 instanceof Hsl)
    return o3;
  o3 = o3.rgb();
  var r3 = o3.r / 255, g3 = o3.g / 255, b3 = o3.b / 255, min4 = Math.min(r3, g3, b3), max4 = Math.max(r3, g3, b3), h2 = NaN, s4 = max4 - min4, l3 = (max4 + min4) / 2;
  if (s4) {
    if (r3 === max4)
      h2 = (g3 - b3) / s4 + (g3 < b3) * 6;
    else if (g3 === max4)
      ...
      h2 = (r3 - g3) / s4 + 4;
    s4 /= l3 < 0.5 ? max4 + min4 : 2 - max4 - min4;
    h2 *= 60;
  } else {
    s4 = l3 > 0 && l3 < 1 ? 0 : h2;
  }
...
define_default(Cubehelix, cubehelix, extend(Color, {
  ...
  rgb() {
    var h2 = isNaN(this.h) ? 0 : (this.h + 120) * radians, l3 = +this.l, a4 = isNaN(this.s) ? 0 : this.s * l3 * (1 - l3), cosh2 = Math.cos(h2), sinh2 = Math.sin(h2);
    return new Rgb(
...
function numberArray_default(a4, b3) {
  if (!b3)
    b3 = [];
  var n3 = a4 ? Math.min(b3.length, a4.length) : 0, c9 = b3.slice(), i3;
  return function(t6) {
    for (i3 = 0; i3 < n3; ++i3)
      c9[i3] = a4[i3] * (1 - t6) + b3[i3] * t6;
    return c9;
  };
}
...
function genericArray(a4, b3) {
  var nb = b3 ? b3.length : 0, na = a4 ? Math.min(nb, a4.length) : 0, x5 = new Array(na), c9 = new Array(nb), i3;
  for (i3 = 0; i3 < na; ++i3)
    x5[i3] = value_default(a4[i3], b3[i3]);
  for (; i3 < nb; ++i3)
    c9[i3] = b3[i3];
  return function(t6) {
    for (i3 = 0; i3 < na; ++i3)
...
function date_default(a4, b3) {
  ...
  return a4 = +a4, b3 = +b3, function(t6) {
    return d3.setTime(a4 * (1 - t6) + b3 * t6), d3;
  };
}
...
function string_default(a4, b3) {
  var bi2 = reA.lastIndex = reB.lastIndex = 0, am, bm, bs, i3 = -1, s4 = [], q = [];
  a4 = a4 + "", b3 = b3 + "";
...
function value_default(a4, b3) {
  var t6 = typeof b3, c9;
  return b3 == null || t6 === "boolean" ? constant_default(b3) : (t6 === "number" ? number_default : t6 === "string" ? (c9 = color(b3)) ? (b3 = c9, rgb_default) : string_default : b3 instanceof color ? rgb_default : b3 instanceof Date ? date_default : isNumberArray(b3) ? numberArray_default : Array.isArray(b3) ? genericArray : typeof b3.valueOf !== "function" && typeof b3.toString !== "function" || isNaN(b3) ? object_default : number_default)(a4, b3);
}

// node_modules/d3-interpolate/src/round.js
function round_default(a4, b3) {
  return a4 = +a4, b3 = +b3, function(t6) {
    return Math.round(a4 * (1 - t6) + b3 * t6);
  };
}
...
function blurh(blur3, T3, S2, w3, h2) {
  for (let y4 = 0, n3 = w3 * h2; y4 < n3; ) {
    blur3(T3, S2, y4, y4 += w3, 1);
  }
}
function blurv(blur3, T3, S2, w3, h2) {
  for (let x5 = 0, n3 = w3 * h2; x5 < w3; ++x5) {
    blur3(T3, S2, x5, x5 + n3, w3);
  }
}
function blurfImage(radius) {
  const blur3 = blurf(radius);
  return (T3, S2, start2, stop2, step) => {
    start2 <<= 2, stop2 <<= 2, step <<= 2;
    blur3(T3, S2, start2 + 0, stop2 + 0, step);
    blur3(T3, S2, start2 + 1, stop2 + 1, step);
    blur3(T3, S2, start2 + 2, stop2 + 2, step);
    blur3(T3, S2, start2 + 3, stop2 + 3, step);
  };
}
function blurf(radius) {
  ...
  return (T3, S2, start2, stop2, step) => {
    ...
    const s1 = s0 + step;
    for (let i3 = start2, j2 = start2 + s0; i3 < j2; i3 += step) {
      sum4 += S2[Math.min(stop2, i3)];
    }
    for (let i3 = start2, j2 = stop2; i3 <= j2; i3 += step) {
      sum4 += S2[Math.min(stop2, i3 + s0)];
      T3[i3] = (sum4 + t6 * (S2[Math.max(start2, i3 - s1)] + S2[Math.min(stop2, i3 + s1)])) / w3;
      sum4 -= S2[Math.max(start2, i3 - s0)];
    }
  };
}
function bluri(radius) {
  ...
  return (T3, S2, start2, stop2, step) => {
    ...
    for (let i3 = start2, j2 = start2 + s4; i3 < j2; i3 += step) {
      sum4 += S2[Math.min(stop2, i3)];
    }
    for (let i3 = start2, j2 = stop2; i3 <= j2; i3 += step) {
      sum4 += S2[Math.min(stop2, i3 + s4)];
      T3[i3] = sum4 / w3;
      sum4 -= S2[Math.max(start2, i3 - s4)];
    }
  };
}
...
function shuffler(random) {
  return function shuffle(array3, i0 = 0, i1 = array3.length) {
    let m4 = i1 - (i0 = +i0);
    while (m4) {
      const i3 = random() * m4-- | 0, t6 = array3[m4 + i0];
      array3[m4 + i0] = array3[i3 + i0];
      array3[i3 + i0] = t6;
    }
    return array3;
  };
...
function ordinal() {
  ...
  function scale(d3) {
    let i3 = index3.get(d3);
    if (i3 === void 0) {
      if (unknown !== implicit)
        return unknown;
      index3.set(d3, i3 = domain.push(d3) - 1);
    }
...
function band() {
  ...
  function rescale() {
    var n3 = domain().length, reverse3 = r1 < r0, start2 = reverse3 ? r1 : r0, stop2 = reverse3 ? r0 : r1;
...
function polymap(domain, range2, interpolate2) {
  var j2 = Math.min(domain.length, range2.length) - 1, d3 = new Array(j2), r3 = new Array(j2), i3 = -1;
...
function formatGroup_default(grouping, thousands) {
  return function(value, width) {
    var i3 = value.length, t6 = [], j2 = 0, g3 = grouping[0], length = 0;
    while (i3 > 0 && g3 > 0) {
...
function loggish(transform) {
  ...
  scale.ticks = (count3) => {
    ...
    if (!(base % 1) && j2 - i3 < n3) {
      ...
      z3 = ticks(i3, j2, Math.min(j2 - i3, n3)).map(pows);
    }
...
function ticker(year2, month2, week, day2, hour2, minute2) {
  ...
  function tickInterval(start2, stop2, count3) {
    ...
    if (i3 === tickIntervals.length)
      return year2.every(tickStep(start2 / durationYear, stop2 / durationYear, count3));
    if (i3 === 0)
      return millisecond.every(Math.max(tickStep(start2, stop2, count3), 1));
...
function ticker2(year2, month2, week, day2, hour2, minute2) {
  ...
  function tickInterval(start2, stop2, count3) {
    ...
    if (i3 === tickIntervals.length)
      return year2.every(tickStep2(start2 / durationYear2, stop2 / durationYear2, count3));
    if (i3 === 0)
      return millisecond_default.every(Math.max(tickStep2(start2, stop2, count3), 1));
    const [t6, step] = tickIntervals[target / tickIntervals[i3 - 1][2] < tickIntervals[i3][2] / target ? i3 - 1 : i3];
    return t6.every(step);
  }
  return [ticks2, tickInterval];
...
function formatLocale(locale3) {
  ...
  function newFormat(specifier, formats2) {
    return function(date2) {
      var string = [], i3 = -1, j2 = 0, n3 = specifier.length, c9, pad2, format2;
      if (!(date2 instanceof Date))
        date2 = /* @__PURE__ */ new Date(+date2);
      while (++i3 < n3) {
        if (specifier.charCodeAt(i3) === 37) {
          string.push(specifier.slice(j2, i3));
          if ((pad2 = pads[c9 = specifier.charAt(++i3)]) != null)
            c9 = specifier.charAt(++i3);
          else
            pad2 = c9 === "e" ? " " : "0";
          if (format2 = formats2[c9])
            c9 = format2(date2, pad2);
          string.push(c9);
          j2 = i3 + 1;
        }
      }
...
function cornerTangents(x0, y0, x1, y1, r1, rc, cw) {
  var x01 = x0 - x1, y01 = y0 - y1, lo = (cw ? rc : -rc) / sqrt2(x01 * x01 + y01 * y01), ox = lo * y01, oy = -lo * x01, x11 = x0 + ox, y11 = y0 + oy, x10 = x1 + ox, y10 = y1 + oy, x00 = (x11 + x10) / 2, y00 = (y11 + y10) / 2, dx = x10 - x11, dy = y10 - y11, d22 = dx * dx + dy * dy, r3 = r1 - rc, D2 = x11 * y10 - x10 * y11, d3 = (dy < 0 ? -1 : 1) * sqrt2(max3(0, r3 * r3 * d22 - D2 * D2)), cx0 = (D2 * dy - dx * d3) / d22, cy0 = (-D2 * dx - dy * d3) / d22, cx1 = (D2 * dy + dx * d3) / d22, cy1 = (-D2 * dx + dy * d3) / d22, dx0 = cx0 - x00, dy0 = cy0 - y00, dx1 = cx1 - x00, dy1 = cy1 - y00;
...
function arc_default() {
  ...
  function arc() {
    ...
    if (!(r1 > epsilon3))
      ...
      var a01 = a0, a11 = a1, a00 = a0, a10 = a1, da0 = da, da1 = da, ap = padAngle.apply(this, arguments) / 2, rp = ap > epsilon3 && (padRadius ? +padRadius.apply(this, arguments) : sqrt2(r0 * r0 + r1 * r1)), rc = min3(abs(r1 - r0) / 2, +cornerRadius.apply(this, arguments)), rc0 = rc, rc1 = rc, t04, t14;
      if (rp > epsilon3) {
  ...
  arc.centroid = function() {
    var r3 = (+innerRadius.apply(this, arguments) + +outerRadius.apply(this, arguments)) / 2, a4 = (+startAngle.apply(this, arguments) + +endAngle.apply(this, arguments)) / 2 - pi2 / 2;
    return [cos(a4) * r3, sin(a4) * r3];
  };
...
function descending_default2(a4, b3) {
  return b3 < a4 ? -1 : b3 > a4 ? 1 : b3 >= a4 ? 0 : NaN;
}
...
function pie_default() {
  var value = identity_default3, sortValues = descending_default2, sort3 = null, startAngle = constant_default3(0), endAngle = constant_default3(tau2), padAngle = constant_default3(0);
  function pie(data) {
    var i3, n3 = data.length, j2, k4, sum4 = 0, index3 = new Array(n3), arcs = new Array(n3), a0 = +startAngle.apply(this, arguments), da = Math.min(tau2, Math.max(-tau2, endAngle.apply(this, arguments) - a0)), a1, p3 = Math.min(Math.abs(da) / n3, padAngle.apply(this, arguments)), pa = p3 * (da < 0 ? -1 : 1), v4;
    for (i3 = 0; i3 < n3; ++i3) {
      if ((v4 = arcs[index3[i3] = i3] = +value(data[i3], i3, data)) > 0) {
        sum4 += v4;
      }
    }
    if (sortValues != null)
      index3.sort(function(i4, j3) {
        return sortValues(arcs[i4], arcs[j3]);
      });
    else if (sort3 != null)
      index3.sort(function(i4, j3) {
        return sort3(data[i4], data[j3]);
      });
    for (i3 = 0, k4 = sum4 ? (da - n3 * pa) / sum4 : 0; i3 < n3; ++i3, a0 = a1) {
      j2 = index3[i3], v4 = arcs[j2], a1 = a0 + (v4 > 0 ? v4 * k4 : 0) + pa, arcs[j2] = {
        data: data[j2],
        index: i3,
        value: v4,
        startAngle: a0,
...
Bundle.prototype = {
  ...
  lineEnd: function() {
    ...
    if (j2 > 0) {
      var x0 = x5[0], y0 = y4[0], dx = x5[j2] - x0, dy = y4[j2] - y0, i3 = -1, t6;
      while (++i3 <= j2) {
        t6 = i3 / j2;
        this._basis.point(
...
function stack_default() {
  ...
  function stack(data) {
    var kz = keys.apply(this, arguments), i3, m4 = data.length, n3 = kz.length, sz = new Array(n3), oz;
    for (i3 = 0; i3 < n3; ++i3) {
      for (var ki2 = kz[i3], si2 = sz[i3] = new Array(m4), j2 = 0, sij; j2 < m4; ++j2) {
  ...
  stack.keys = function(_) {
    return arguments.length ? (keys = typeof _ === "function" ? _ : constant_default3(slice3.call(_)), stack) : keys;
  };
  stack.value = function(_) {
    return arguments.length ? (value = typeof _ === "function" ? _ : constant_default3(+_), stack) : value;
  };
  stack.order = function(_) {
    return arguments.length ? (order = _ == null ? none_default2 : typeof _ === "function" ? _ : constant_default3(slice3.call(_)), stack) : order;
  };
...
function insideOut_default(series) {
  var n3 = series.length, i3, j2, sums = series.map(sum3), order = appearance_default(series), top = 0, bottom = 0, tops = [], bottoms = [];
  for (i3 = 0; i3 < n3; ++i3) {
    j2 = order[i3];
    if (top < bottom) {
      top += sums[j2];
...
var Ir = import_prop_types.default.shape({ hidden: import_prop_types.default.shape({ symbol: import_prop_types.default.shape({ fill: import_prop_types.default.string.isRequired, opacity: import_prop_types.default.number }).isRequired, text: import_prop_types.default.shape(Mr({}, Br, { opacity: import_prop_types.default.number })).isRequired }).isRequired, text: import_prop_types.default.shape(Mr({}, Br)).isRequired });
var Dr = import_prop_types.default.shape({ text: import_prop_types.default.shape(Mr({}, Br)).isRequired });
var Yr = import_prop_types.default.shape({ text: import_prop_types.default.shape(Mr({}, Br)).isRequired });
var Ar = import_prop_types.default.shape({ text: import_prop_types.default.shape(Mr({}, Br)).isRequired });
...
var Kr = function(e6, r3) {
  var t6 = (0, import_merge3.default)({}, e6, r3);
  return Hr.forEach(function(e7) {
    void 0 === (0, import_get.default)(t6, e7 + ".fontFamily") && (0, import_set2.default)(t6, e7 + ".fontFamily", t6.text.fontFamily), void 0 === (0, import_get.default)(t6, e7 + ".fontSize") && (0, import_set2.default)(t6, e7 + ".fontSize", t6.text.fontSize), void 0 === (0, import_get.default)(t6, e7 + ".fill") && (0, import_set2.default)(t6, e7 + ".fill", t6.text.fill), void 0 === (0, import_get.default)(t6, e7 + ".outlineWidth") && (0, import_set2.default)(t6, e7 + ".outlineWidth", t6.text.outlineWidth), void 0 === (0, import_get.default)(t6, e7 + ".outlineColor") && (0, import_set2.default)(t6, e7 + ".outlineColor", t6.text.outlineColor);
  }), t6;
};
var Nr = (0, import_react15.createContext)();
var Jr = function(e6) {
  var t6 = e6.children, i3 = e6.animate, n3 = void 0 === i3 || i3, o3 = e6.config, a4 = void 0 === o3 ? "default" : o3, l3 = (0, import_react15.useMemo)(function() {
    var e7 = (0, import_isString.default)(a4) ? config[a4] : a4;
    return { animate: n3, config: e7 };
  }, [n3, a4]);
  return (0, import_jsx_runtime.jsx)(Nr.Provider, { value: l3, children: t6 });
};
...
var $r = function(e6) {
  var t6 = Zr(), o3 = t6.animate, a4 = t6.config, l3 = function(e7) {
...
var Pt = { top: 0, right: 0, bottom: 0, left: 0 };
var Bt = function(e6, t6, i3) {
...
var At = {};
var Ft = function(e6) {
  var r3 = e6.theme, t6 = void 0 === r3 ? At : r3, i3 = e6.children, n3 = Lt(t6);
...
var Ht = function(e6) {
  ...
  return (0, import_jsx_runtime.jsx)(Ft, { theme: t6, children: (0, import_jsx_runtime.jsx)(Jr, { animate: s4, config: d3, children: (0, import_jsx_runtime.jsx)(M, { container: u3, children: (0, import_jsx_runtime.jsxs)(Ut, { condition: o3, wrapper: (0, import_jsx_runtime.jsx)("div", { style: Xt, ref: u3 }), children: [r3, l3 && (0, import_jsx_runtime.jsx)(F, {})] }) }) }) });
};
...
var Jt = function(e6) {
  var r3 = e6.children, t6 = Gt(), i3 = t6[0], n3 = t6[1], o3 = n3.width > 0 && n3.height > 0;
...
var Qt = ["id", "colors"];
var Zt = function(e6) {
  var r3 = e6.id, t6 = e6.colors, i3 = Pr(e6, Qt);
...
var ri = { color: "#000000", background: "#ffffff", size: 4, padding: 4, stagger: false };
var ti = (0, import_react15.memo)(function(e6) {
  var r3 = e6.id, t6 = e6.background, i3 = void 0 === t6 ? ri.background : t6, n3 = e6.color, o3 = void 0 === n3 ? ri.color : n3, a4 = e6.size, l3 = void 0 === a4 ? ri.size : a4, s4 = e6.padding, d3 = void 0 === s4 ? ri.padding : s4, u3 = e6.stagger, c9 = void 0 === u3 ? ri.stagger : u3, f3 = l3 + d3, p3 = l3 / 2, h2 = d3 / 2;
  return true === c9 && (f3 = 2 * l3 + 2 * d3), (0, import_jsx_runtime.jsxs)("pattern", { id: r3, width: f3, height: f3, patternUnits: "userSpaceOnUse", children: [(0, import_jsx_runtime.jsx)("rect", { width: f3, height: f3, fill: i3 }), (0, import_jsx_runtime.jsx)("circle", { cx: h2 + p3, cy: h2 + p3, r: p3, fill: o3 }), c9 && (0, import_jsx_runtime.jsx)("circle", { cx: 1.5 * d3 + l3 + p3, cy: 1.5 * d3 + l3 + p3, r: p3, fill: o3 })] });
});
...
var gi = { spacing: 5, rotation: 0, background: "#000000", color: "#ffffff", lineWidth: 2 };
var bi = (0, import_react15.memo)(function(e6) {
  var r3 = e6.id, t6 = e6.spacing, i3 = void 0 === t6 ? gi.spacing : t6, n3 = e6.rotation, o3 = void 0 === n3 ? gi.rotation : n3, a4 = e6.background, l3 = void 0 === a4 ? gi.background : a4, s4 = e6.color, d3 = void 0 === s4 ? gi.color : s4, u3 = e6.lineWidth, c9 = void 0 === u3 ? gi.lineWidth : u3, f3 = Math.round(o3) % 360, p3 = Math.abs(i3);
  f3 > 180 ? f3 -= 360 : f3 > 90 ? f3 -= 180 : f3 < -180 ? f3 += 360 : f3 < -90 && (f3 += 180);
  var h2, g3 = p3, b3 = p3;
  return 0 === f3 ? h2 = "\n                M 0 0 L " + g3 + " 0\n                M 0 " + b3 + " L " + g3 + " " + b3 + "\n            " : 90 === f3 ? h2 = "\n                M 0 0 L 0 " + b3 + "\n                M " + g3 + " 0 L " + g3 + " " + b3 + "\n            " : (g3 = Math.abs(p3 / Math.sin(oi(f3))), b3 = p3 / Math.sin(oi(90 - f3)), h2 = f3 > 0 ? "\n                    M 0 " + -b3 + " L " + 2 * g3 + " " + b3 + "\n                    M " + -g3 + " " + -b3 + " L " + g3 + " " + b3 + "\n                    M " + -g3 + " 0 L " + g3 + " " + 2 * b3 + "\n                " : "\n                    M " + -g3 + " " + b3 + " L " + g3 + " " + -b3 + "\n                    M " + -g3 + " " + 2 * b3 + " L " + 2 * g3 + " " + -b3 + "\n                    M 0 " + 2 * b3 + " L " + 2 * g3 + " 0\n                "), (0, import_jsx_runtime.jsxs)("pattern", { id: r3, width: g3, height: b3, patternUnits: "userSpaceOnUse", children: [(0, import_jsx_runtime.jsx)("rect", { width: g3, height: b3, fill: l3, stroke: "rgba(255, 0, 0, 0.1)", strokeWidth: 0 }), (0, import_jsx_runtime.jsx)("path", { d: h2, strokeWidth: c9, stroke: d3, strokeLinecap: "square" })] });
});
bi.displayName = "PatternLines", bi.propTypes = { id: import_prop_types.default.string.isRequired, spacing: import_prop_types.default.number.isRequired, rotation: import_prop_types.default.number.isRequired, background: import_prop_types.default.string.isRequired, color: import_prop_types.default.string.isRequired, lineWidth: import_prop_types.default.number.isRequired };
var yi = { color: "#000000", background: "#ffffff", size: 4, padding: 4, stagger: false };
var vi = (0, import_react15.memo)(function(e6) {
  var r3 = e6.id, t6 = e6.color, i3 = void 0 === t6 ? yi.color : t6, n3 = e6.background, o3 = void 0 === n3 ? yi.background : n3, a4 = e6.size, l3 = void 0 === a4 ? yi.size : a4, s4 = e6.padding, d3 = void 0 === s4 ? yi.padding : s4, u3 = e6.stagger, c9 = void 0 === u3 ? yi.stagger : u3, f3 = l3 + d3, p3 = d3 / 2;
  return true === c9 && (f3 = 2 * l3 + 2 * d3), (0, import_jsx_runtime.jsxs)("pattern", { id: r3, width: f3, height: f3, patternUnits: "userSpaceOnUse", children: [(0, import_jsx_runtime.jsx)("rect", { width: f3, height: f3, fill: o3 }), (0, import_jsx_runtime.jsx)("rect", { x: p3, y: p3, width: l3, height: l3, fill: i3 }), c9 && (0, import_jsx_runtime.jsx)("rect", { x: 1.5 * d3 + l3, y: 1.5 * d3 + l3, width: l3, height: l3, fill: i3 })] });
});
vi.displayName = "PatternSquares", vi.propTypes = { id: import_prop_types.default.string.isRequired, color: import_prop_types.default.string.isRequired, background: import_prop_types.default.string.isRequired, size: import_prop_types.default.number.isRequired, padding: import_prop_types.default.number.isRequired, stagger: import_prop_types.default.bool.isRequired };
var qi = { patternDots: ti, patternLines: bi, patternSquares: vi };
var ki = ["type"];
var _i = Mr({}, ei, qi);
var wi = function(e6) {
  var r3 = e6.defs;
  return !r3 || r3.length < 1 ? null : (0, import_jsx_runtime.jsx)("defs", { "aria-hidden": true, children: r3.map(function(e7) {
    var r4 = e7.type, t6 = Pr(e7, ki);
    return _i[r4] ? (0, import_react15.createElement)(_i[r4], Mr({ key: t6.id }, t6)) : null;
  }) });
};
wi.propTypes = { defs: import_prop_types.default.arrayOf(import_prop_types.default.shape({ type: import_prop_types.default.oneOf(Object.keys(_i)).isRequired, id: import_prop_types.default.string.isRequired })) };
var xi = (0, import_react15.memo)(wi);
var Oi = function(e6) {
  var r3 = e6.width, t6 = e6.height, i3 = e6.margin, n3 = e6.defs, o3 = e6.children, a4 = e6.role, l3 = e6.ariaLabel, s4 = e6.ariaLabelledBy, d3 = e6.ariaDescribedBy, u3 = e6.isFocusable, c9 = Et();
  return (0, import_jsx_runtime.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: r3, height: t6, role: a4, "aria-label": l3, "aria-labelledby": s4, "aria-describedby": d3, focusable: u3, tabIndex: u3 ? 0 : void 0, children: [(0, import_jsx_runtime.jsx)(xi, { defs: n3 }), (0, import_jsx_runtime.jsx)("rect", { width: r3, height: t6, fill: c9.background }), (0, import_jsx_runtime.jsx)("g", { transform: "translate(" + i3.left + "," + i3.top + ")", children: o3 })] });
};
Oi.propTypes = { width: import_prop_types.default.number.isRequired, height: import_prop_types.default.number.isRequired, margin: import_prop_types.default.shape({ top: import_prop_types.default.number.isRequired, left: import_prop_types.default.number.isRequired }).isRequired, defs: import_prop_types.default.array, children: import_prop_types.default.oneOfType([import_prop_types.default.arrayOf(import_prop_types.default.node), import_prop_types.default.node]).isRequired, role: import_prop_types.default.string, isFocusable: import_prop_types.default.bool, ariaLabel: import_prop_types.default.string, ariaLabelledBy: import_prop_types.default.string, ariaDescribedBy: import_prop_types.default.string };
var Wi = function(e6) {
...
var zi = function(e6) {
  var r3 = e6.x, t6 = e6.y, i3 = e6.symbol, n3 = void 0 === i3 ? Ci : i3, o3 = e6.size, a4 = e6.datum, l3 = e6.color, s4 = e6.borderWidth, u3 = e6.borderColor, c9 = e6.label, f3 = e6.labelTextAnchor, p3 = void 0 === f3 ? "middle" : f3, h2 = e6.labelYOffset, g3 = void 0 === h2 ? -12 : h2, b3 = Et(), m4 = Zr(), y4 = m4.animate, v4 = m4.config, R = useSpring({ transform: "translate(" + r3 + ", " + t6 + ")", config: v4, immediate: !y4 });
...
zi.propTypes = { x: import_prop_types.default.number.isRequired, y: import_prop_types.default.number.isRequired, datum: import_prop_types.default.object.isRequired, size: import_prop_types.default.number.isRequired, color: import_prop_types.default.string.isRequired, borderWidth: import_prop_types.default.number.isRequired, borderColor: import_prop_types.default.string.isRequired, symbol: import_prop_types.default.oneOfType([import_prop_types.default.func, import_prop_types.default.object]), label: import_prop_types.default.oneOfType([import_prop_types.default.string, import_prop_types.default.number]), labelTextAnchor: import_prop_types.default.oneOf(["start", "middle", "end"]), labelYOffset: import_prop_types.default.number };
var Ti = (0, import_react15.memo)(zi);
var Si = function(e6) {
  var r3 = e6.width, t6 = e6.height, i3 = e6.axis, n3 = e6.scale, o3 = e6.value, a4 = e6.lineStyle, l3 = e6.textStyle, s4 = e6.legend, d3 = e6.legendPosition, u3 = void 0 === d3 ? "top-right" : d3, c9 = e6.legendOffsetX, f3 = void 0 === c9 ? 14 : c9, p3 = e6.legendOffsetY, h2 = void 0 === p3 ? 14 : p3, g3 = e6.legendOrientation, b3 = void 0 === g3 ? "horizontal" : g3, m4 = Et(), y4 = 0, v4 = 0, R = 0, q = 0;
  "y" === i3 ? (R = n3(o3), v4 = r3) : (y4 = n3(o3), q = t6);
  var k4 = null;
  if (s4) {
    var _ = function(e7) {
    ...
    }({ axis: i3, width: r3, height: t6, position: u3, offsetX: f3, offsetY: h2, orientation: b3 });
    k4 = (0, import_jsx_runtime.jsx)("text", { transform: "translate(" + _.x + ", " + _.y + ") rotate(" + _.rotation + ")", textAnchor: _.textAnchor, dominantBaseline: "central", style: l3, children: s4 });
  }
  return (0, import_jsx_runtime.jsxs)("g", { transform: "translate(" + y4 + ", " + R + ")", children: [(0, import_jsx_runtime.jsx)("line", { x1: 0, x2: v4, y1: 0, y2: q, stroke: m4.markers.lineColor, strokeWidth: m4.markers.lineStrokeWidth, style: a4 }), k4] });
};
...
var Mi = (0, import_react15.memo)(Si);
var ji = function(e6) {
  var r3 = e6.markers, t6 = e6.width, i3 = e6.height, n3 = e6.xScale, o3 = e6.yScale;
  return r3 && 0 !== r3.length ? r3.map(function(e7, r4) {
    return (0, import_jsx_runtime.jsx)(Mi, Mr({}, e7, { width: t6, height: i3, scale: "y" === e7.axis ? o3 : n3 }), r4);
  }) : null;
};
...
var Pi = (0, import_react15.memo)(ji);
var Ii = function(e6) {
...
var Fi = function(e6, r3, t6, i3) {
  var n3 = t6 - e6, o3 = i3 - r3;
  return n3 *= n3, o3 *= o3, Math.sqrt(n3 + o3);
};
var Ei = function(e6, r3, t6, i3) {
  var n3 = Math.atan2(i3 - r3, t6 - e6) - Math.PI / 2;
  return n3 > 0 ? n3 : 2 * Math.PI + n3;
};
var Ui = function(e6, r3, t6, i3, n3, o3) {
  return e6 <= n3 && n3 <= e6 + t6 && r3 <= o3 && o3 <= r3 + i3;
};
var Xi = function(e6, r3) {
  var t6, i3 = "touches" in r3 ? r3.touches[0] : r3, n3 = i3.clientX, o3 = i3.clientY, a4 = e6.getBoundingClientRect(), l3 = (t6 = void 0 !== e6.getBBox ? e6.getBBox() : { width: e6.offsetWidth || 0, height: e6.offsetHeight || 0 }).width === a4.width ? 1 : t6.width / a4.width;
  return [(n3 - a4.left) * l3, (o3 - a4.top) * l3];
};
var Hi = Object.keys(ei);
var Ki = Object.keys(qi);
var Ni = function(e6, r3, t6) {
  if ("*" === e6)
    return true;
...
var b = (0, import_react16.memo)(function(t6) {
  var o3, n3 = t6.position, r3 = t6.anchor, e6 = t6.children, l3 = Et(), d3 = Zr(), p3 = d3.animate, f3 = d3.config, b3 = Gt(), g3 = b3[0], w3 = b3[1], T3 = (0, import_react16.useRef)(false), C5 = void 0, E3 = false, P2 = w3.width > 0 && w3.height > 0, j2 = Math.round(n3[0]), N2 = Math.round(n3[1]);
  P2 && ("top" === r3 ? (j2 -= w3.width / 2, N2 -= w3.height + 14) : "right" === r3 ? (j2 += 14, N2 -= w3.height / 2) : "bottom" === r3 ? (j2 -= w3.width / 2, N2 += 14) : "left" === r3 ? (j2 -= w3.width + 14, N2 -= w3.height / 2) : "center" === r3 && (j2 -= w3.width / 2, N2 -= w3.height / 2), C5 = { transform: m2(j2, N2) }, T3.current || (E3 = true), T3.current = [j2, N2]);
  var O3 = useSpring({ to: C5, config: f3, immediate: !p3 || E3 }), V2 = v2({}, x3, l3.tooltip, { transform: null != (o3 = O3.transform) ? o3 : m2(j2, N2), opacity: O3.transform ? 1 : 0 });
...
var w = (0, import_react16.memo)(function(t6) {
  var i3, o3 = t6.id, n3 = t6.value, r3 = t6.format, e6 = t6.enableChip, l3 = void 0 !== e6 && e6, a4 = t6.color, c9 = t6.renderContent, h2 = Et(), u3 = Dt(r3);
  if ("function" == typeof c9)
    i3 = c9();
  else {
    var f3 = n3;
    void 0 !== u3 && void 0 !== f3 && (f3 = u3(f3)), i3 = (0, import_jsx_runtime2.jsxs)("div", { style: h2.tooltip.basic, children: [l3 && (0, import_jsx_runtime2.jsx)(g, { color: a4, style: h2.tooltip.chip }), void 0 !== f3 ? (0, import_jsx_runtime2.jsxs)("span", { children: [o3, ": ", (0, import_jsx_runtime2.jsx)("strong", { children: "" + f3 })] }) : o3] });
  }
...
var C3 = (0, import_react16.memo)(function(t6) {
  var i3, o3 = t6.title, n3 = t6.rows, r3 = void 0 === n3 ? [] : n3, e6 = t6.renderContent, l3 = Et();
...
var E2 = (0, import_react16.memo)(function(t6) {
  var i3 = t6.x0, n3 = t6.x1, r3 = t6.y0, e6 = t6.y1, l3 = Et(), u3 = Zr(), d3 = u3.animate, p3 = u3.config, f3 = (0, import_react16.useMemo)(function() {
    return v2({}, l3.crosshair.line, { pointerEvents: "none" });
  }, [l3.crosshair.line]), x5 = useSpring({ x1: i3, x2: n3, y1: r3, y2: e6, config: p3, immediate: !d3 });
...
var V = function(t6) {
  var i3 = (0, import_react16.useState)(N), n3 = i3[0], l3 = i3[1], a4 = (0, import_react16.useCallback)(function(t7, i4, o3) {
    ...
    void 0 === n4 && (n4 = "top");
    var r3 = t6.current.getBoundingClientRect(), e6 = t6.current.offsetWidth, a5 = e6 === r3.width ? 1 : e6 / r3.width, c10 = "touches" in o3 ? o3.touches[0] : o3, s5 = c10.clientX, h2 = c10.clientY, u3 = (s5 - r3.left) * a5, d3 = (h2 - r3.top) * a5;
  ...
  if ((0, import_isPlainObject2.default)(e6)) {
    ...
    if (function(e7) {
      ...
      if (Je(e6.scheme)) {
        ...
        var s4 = ordinal($e[e6.scheme][e6.size || 9]), c9 = function(e7) {
          return s4(n3(e7));
        };
...
var C4 = { circle: m3, diamond: f2, square: u2, triangle: v3 };
var B2 = function(i3) {
  var n3, r3, l3, c9, h2, g3, m4, f3, u3, v4, y4, b3 = i3.x, k4 = i3.y, x5 = i3.width, A3 = i3.height, W2 = i3.data, O3 = i3.direction, z3 = void 0 === O3 ? "left-to-right" : O3, B3 = i3.justify, w3 = void 0 !== B3 && B3, X2 = i3.textColor, Y2 = i3.background, H2 = void 0 === Y2 ? "transparent" : Y2, E3 = i3.opacity, j2 = void 0 === E3 ? 1 : E3, T3 = i3.symbolShape, L = void 0 === T3 ? "square" : T3, M2 = i3.symbolSize, F2 = void 0 === M2 ? 16 : M2, P2 = i3.symbolSpacing, R = void 0 === P2 ? 8 : P2, q = i3.symbolBorderWidth, V2 = void 0 === q ? 0 : q, D2 = i3.symbolBorderColor, G = void 0 === D2 ? "transparent" : D2, I = i3.onClick, N2 = i3.onMouseEnter, _ = i3.onMouseLeave, J = i3.toggleSerie, K2 = i3.effects, Q = (0, import_react18.useState)({}), U = Q[0], Z = Q[1], $ = Et(), tt = (0, import_react18.useCallback)(function(t6) {
    if (K2) {
      var e6 = K2.filter(function(t7) {
        return "hover" === t7.on;
    ...
    null == N2 || N2(W2, t6);
  }, [N2, W2, K2]), et2 = (0, import_react18.useCallback)(function(t6) {
    if (K2) {
      var e6 = K2.filter(function(t7) {
        return "hover" !== t7.on;
      }).reduce(function(t7, e7) {
    ...
    null == _ || _(W2, t6);
  }, [_, W2, K2]), it2 = S({ direction: z3, justify: w3, symbolSize: null != (n3 = U.symbolSize) ? n3 : F2, symbolSpacing: R, width: x5, height: A3 }), nt = it2.symbolX, ot = it2.symbolY, rt2 = it2.labelX, lt = it2.labelY, at = it2.labelAnchor, ct2 = it2.labelAlignment, st = [I, N2, _, J].some(function(t6) {
    return void 0 !== t6;
  }), dt2 = "function" == typeof L ? L : C4[L];
  return (0, import_jsx_runtime3.jsxs)("g", { transform: "translate(" + b3 + "," + k4 + ")", style: { opacity: null != (r3 = U.itemOpacity) ? r3 : j2 }, children: [(0, import_jsx_runtime3.jsx)("rect", { width: x5, height: A3, fill: null != (l3 = U.itemBackground) ? l3 : H2, style: { cursor: st ? "pointer" : "auto" }, onClick: function(t6) {
...
var w2 = function(e6) {
  var i3 = e6.data, n3 = e6.x, o3 = e6.y, r3 = e6.direction, l3 = e6.padding, a4 = void 0 === l3 ? 0 : l3, c9 = e6.justify, s4 = e6.effects, d3 = e6.itemWidth, h2 = e6.itemHeight, g3 = e6.itemDirection, m4 = void 0 === g3 ? "left-to-right" : g3, f3 = e6.itemsSpacing, u3 = void 0 === f3 ? 0 : f3, v4 = e6.itemTextColor, p3 = e6.itemBackground, y4 = void 0 === p3 ? "transparent" : p3, b3 = e6.itemOpacity, x5 = void 0 === b3 ? 1 : b3, S2 = e6.symbolShape, A3 = e6.symbolSize, W2 = e6.symbolSpacing, O3 = e6.symbolBorderWidth, z3 = e6.symbolBorderColor, C5 = e6.onClick, w3 = e6.onMouseEnter, X2 = e6.onMouseLeave, Y2 = e6.toggleSerie, H2 = k3({ itemCount: i3.length, itemWidth: d3, itemHeight: h2, itemsSpacing: u3, direction: r3, padding: a4 }).padding, E3 = "row" === r3 ? d3 + u3 : 0, j2 = "column" === r3 ? h2 + u3 : 0;
  return (0, import_jsx_runtime3.jsx)("g", { transform: "translate(" + n3 + "," + o3 + ")", children: i3.map(function(e7, i4) {
    return (0, import_jsx_runtime3.jsx)(B2, { data: e7, x: i4 * E3 + H2.left, y: i4 * j2 + H2.top, width: d3, height: h2, direction: m4, justify: c9, effects: s4, textColor: v4, background: y4, opacity: x5, symbolShape: S2, symbolSize: A3, symbolSpacing: W2, symbolBorderWidth: O3, symbolBorderColor: z3, onClick: C5, onMouseEnter: w3, onMouseLeave: X2, toggleSerie: Y2 }, i4);
  }) });
};
var X = function(e6) {
  var i3 = e6.data, n3 = e6.containerWidth, o3 = e6.containerHeight, r3 = e6.translateX, l3 = void 0 === r3 ? 0 : r3, a4 = e6.translateY, c9 = void 0 === a4 ? 0 : a4, s4 = e6.anchor, d3 = e6.direction, h2 = e6.padding, g3 = void 0 === h2 ? 0 : h2, m4 = e6.justify, f3 = e6.itemsSpacing, u3 = void 0 === f3 ? 0 : f3, v4 = e6.itemWidth, p3 = e6.itemHeight, y4 = e6.itemDirection, b3 = e6.itemTextColor, S2 = e6.itemBackground, A3 = e6.itemOpacity, W2 = e6.symbolShape, O3 = e6.symbolSize, z3 = e6.symbolSpacing, C5 = e6.symbolBorderWidth, B3 = e6.symbolBorderColor, X2 = e6.onClick, Y2 = e6.onMouseEnter, H2 = e6.onMouseLeave, E3 = e6.toggleSerie, j2 = e6.effects, T3 = k3({ itemCount: i3.length, itemsSpacing: u3, itemWidth: v4, itemHeight: p3, direction: d3, padding: g3 }), L = T3.width, M2 = T3.height, F2 = x4({ anchor: s4, translateX: l3, translateY: c9, containerWidth: n3, containerHeight: o3, width: L, height: M2 }), P2 = F2.x, R = F2.y;
  return (0, import_jsx_runtime3.jsx)(w2, { data: i3, x: P2, y: R, direction: d3, padding: g3, justify: m4, effects: j2, itemsSpacing: u3, itemWidth: v4, itemHeight: p3, itemDirection: y4, itemTextColor: b3, itemBackground: S2, itemOpacity: A3, symbolShape: W2, symbolSize: O3, symbolSpacing: z3, symbolBorderWidth: C5, symbolBorderColor: B3, onClick: X2, onMouseEnter: Y2, onMouseLeave: H2, toggleSerie: "boolean" == typeof E3 ? void 0 : E3 });
};
var Y = { start: "left", middle: "center", end: "right" };
var H = function(t6, e6) {
  var i3 = e6.data, n3 = e6.containerWidth, o3 = e6.containerHeight, r3 = e6.translateX, l3 = void 0 === r3 ? 0 : r3, a4 = e6.translateY, c9 = void 0 === a4 ? 0 : a4, s4 = e6.anchor, d3 = e6.direction, h2 = e6.padding, g3 = void 0 === h2 ? 0 : h2, m4 = e6.justify, f3 = void 0 !== m4 && m4, u3 = e6.itemsSpacing, v4 = void 0 === u3 ? 0 : u3, p3 = e6.itemWidth, y4 = e6.itemHeight, b3 = e6.itemDirection, A3 = void 0 === b3 ? "left-to-right" : b3, W2 = e6.itemTextColor, O3 = e6.symbolSize, z3 = void 0 === O3 ? 16 : O3, C5 = e6.symbolSpacing, B3 = void 0 === C5 ? 8 : C5, w3 = e6.theme, X2 = k3({ itemCount: i3.length, itemWidth: p3, itemHeight: y4, itemsSpacing: v4, direction: d3, padding: g3 }), H2 = X2.width, E3 = X2.height, j2 = X2.padding, T3 = x4({ anchor: s4, translateX: l3, translateY: c9, containerWidth: n3, containerHeight: o3, width: H2, height: E3 }), L = T3.x, M2 = T3.y, F2 = "row" === d3 ? p3 + v4 : 0, P2 = "column" === d3 ? y4 + v4 : 0;
  t6.save(), t6.translate(L, M2), t6.font = w3.legends.text.fontSize + "px " + (w3.legends.text.fontFamily || "sans-serif"), i3.forEach(function(e7, i4) {
    var n4, o4, r4 = i4 * F2 + j2.left, l4 = i4 * P2 + j2.top, a5 = S({ direction: A3, justify: f3, symbolSize: z3, symbolSpacing: B3, width: p3, height: y4 }), c10 = a5.symbolX, s5 = a5.symbolY, d4 = a5.labelX, h3 = a5.labelY, g4 = a5.labelAnchor, m5 = a5.labelAlignment;
...
object-assign/index.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-TBNM4BYT.js.map
